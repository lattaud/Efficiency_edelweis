...
////////////////////////////////////////////////////////////////////////
	...
	TH1D *h1EoutLine_2_EoutvsEtot[Ntol][Nlines];
	...
	TGraph* Etot_vs_Ein_2 = new TGraph();
	...
	for(int tol_index=0;tol_index<N_tolerances;tol_index++){
		for(int l=0;l<Nlines;l++){
			...
			h1EoutLine_2_EoutvsEtot[tol_index][l]=new TH1D(Form("h1EoutLine_2_EoutvsEtot%i_%i",tol_index,l),"",Nbinsout,Eminout,Emaxout);
            	 		...
            	 		if(tol_index==0){
						   ...
						   if(coinc_simu_datasimu_anticoinc_data){							
							   ...
							   if(passALLcut){
								   ...
								   h1EoutLine_2_EoutvsEtot[tol_index][t]->Fill(energy_in_kevTot);
...
for(int l=0;l<Nlines;l++){
   ...
   bool fit = true;
   if(fit == true){
   double Nreso_E = 3*sqrt(pow(0.05,2)+pow(0.05*Eline[l],2));
   h1EoutLine_0_EoutvsE[0][l]->Fit("gaus","","",Eline[l]-Nreso_E,Eline[l]+Nreso_E);
   h1EoutLine_1_EoutvsE[0][l]->Fit("gaus","","",Eline[l]-Nreso_E,Eline[l]+Nreso_E);
   h1EoutLine_2_EoutvsE[0][l]->Fit("gaus","","",Eline[l]-Nreso_E,Eline[l]+Nreso_E);
   
   h1EoutLine_2_EoutvsEtot[0][l]->Fit("gaus","","",Eline[l]-Nreso_E,Eline[l]+Nreso_E);
   
   h1EoutLine_0_EoutvsEB[0][l]->Fit("gaus","","",Eline[l]-Nreso_E,Eline[l]+Nreso_E);
   h1EoutLine_1_EoutvsEB[0][l]->Fit("gaus","","",Eline[l]-Nreso_E,Eline[l]+Nreso_E);
   h1EoutLine_2_EoutvsEB[0][l]->Fit("gaus","","",Eline[l]-Nreso_E,Eline[l]+Nreso_E);
   ...
   h1Line_2_EoutvsEion[0][l][1]->Write();
	...
	Etot_vs_Ein_2->SetPoint(l,Eline[l],h1EoutLine_2_EoutvsEtot[0][l]->GetFunction("gaus")->GetParameter(1));
...
Etot_vs_Ein_2->Write("ETotout_vsEin_passcut_coinc");
