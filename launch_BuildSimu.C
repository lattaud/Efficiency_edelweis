void launch_BuildSimu()
{
   ...
   vecrun.push_back("uf02a000");
    ...
    outputdirectory=outputdirectory+"/SimuCoinc";
	...
	string script="/sps/edelweis/rootDataRun317/streams/Selection10keV_Migdal/runBuildSimu.sh";
...
for(int r=0;r<NRUNS;r++){
	for(int d=0;d<NDET;d++){
		    ...
		    string cmd2=softdirectory+" "+outputdirectory;          
            string cmd3=Form(" %s ",ProcessedData_Dir.c_str());
            string cmd4=Form(" %s ",SimuData_Dir.c_str());          
